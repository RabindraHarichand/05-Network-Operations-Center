...
describe("FilesSystemDatasource", () => {
  ...
  test("should save a log in all logs logs-all.log", () => {
  ...
  test("should save a log in all logs logs-all.log and in logs-medium.log", () => {
    const LogDatasource = new FileSystemDatasource();
    const log = new LogEntity({
      message: "test",
  ...
  test("should save a log in all logs logs-all.log and in logs-high.log", () => {
    const LogDatasource = new FileSystemDatasource();
    const log = new LogEntity({
      message: "test",
