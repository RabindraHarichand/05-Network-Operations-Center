...
describe("CheckService UseCase", () => {
  ...
  const multipleCheckServices = new CheckServiceMultiple(
  ...
  test("should call successCallback when fetch returns true", async () => {
    const wasOk = await multipleCheckServices.execute("https://google.com");
  ...
  test("should call errorCallback when fetch returns false", async () => {
    const wasOk = await multipleCheckServices.execute("https://gooasdfgle.com");
